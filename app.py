...
# --- AI CORE: DIRECT API CALL (FIXED FOR SAFETY & CANDIDATES ERROR) ---
def ask_gemini_ai(prompt_text):
    ...
    # गुगलचा अधिकृत v1 एंडपॉइंट
    url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key={api_key}"
    
    headers = {'Content-Type': 'application/json'}
    
    # नवीन सुरक्षा फिल्टर आणि अचूक पेलोड रचना (Safety Settings Added)
    payload = {
        "contents": [{
            "parts": [{
                "text": f"You are Abhyas Kranti AI Mentor. Explain the following topic simply in Marathi language suitable for school students. Question: {prompt_text}"
            }]
        }],
        "safetySettings": [
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # डेटा सुरक्षितपणे वाचणे जेणेकरून KeyError येणार नाही
            if 'candidates' in response_data and response_data['candidates']:
                candidate = response_data['candidates'][0]
                if 'content' in candidate and 'parts' in candidate['content']:
                    return candidate['content']['parts'][0]['text']
                elif 'finishReason' in candidate and candidate['finishReason'] == 'SAFETY':
                    return "सुरक्षा कारणास्तव गुगलने या प्रश्नाचे उत्तर ब्लॉक केले आहे. कृपया दुसरा शैक्षणिक प्रश्न विचारा."
            
            return "गुगल एआय कडून आलेल्या उत्तरात तांत्रिक बिघाड आहे किंवा उत्तर रिकामे आहे."
        else:
            return f"गुगल सर्व्हर एरर (Status Code: {response.status_code}). कृपया तुमची API Key किंवा कोटा तपासा."
...
with tab1:
    ...
    if st.button("उत्तर शोधा (Ask AI)"):
        if not st.session_state.logged_in:
            st.warning("कृपया आधी डाव्या बाजूला कोणतेही नाव टाकून लॉगिन करा!")
