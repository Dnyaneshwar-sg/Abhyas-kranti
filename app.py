...
# ==========================================
    ...
    # येथे 'key="sandbox_selection"' हा अत्यंत महत्त्वाचा बदल केला आहे, ज्यामुळे स्टेट लॉक होईल
    ...
    # ५. Career Guidance System
        ...
        interests_field = st.text_input("विद्यार्थ्याची आवड किंवा क्षेत्र (उदा. शे體, इलेक्ट्रॉनिक्स, सोलर, टेलरिंग):", "सोलर आणि आधुनिक शेती", key="q5")
        
        if st.button("🚀 भविष्यातील करिअर मार्ग phospho", key="btn5"):
