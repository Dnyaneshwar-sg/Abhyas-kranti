...
if app_mode == "🏠 मुख्य पान (Dashboard)":
    ...
    with a_col3: st.markdown('<div class="arch-step">📊 Cloud Storage<br><span style="font-size:0.75rem; color:#94a3b8;">Supabase Secure Matrix</span></div>', unsafe_allow_html=True)
...
# ==========================================
# विभाग २: AI प्रगत फीचर्स सँडबॉक्स (6-in-1 Live Engine via TABS)
# ==========================================
elif app_mode == "⚡ AI प्रगत फीचर्स सँडबॉक्स":
    st.title("⚡ अभ्यास क्रांती AI Action Sandbox")
    st.markdown('<p style="color: #cbd5e1;">खालील टॅब्सवर क्लिक करून वेगवेगळ्या AI मॉड्यूल्सचा लाईव्ह अनुभव घ्या:</p>', unsafe_allow_html=True)

    # येथे आपण आधुनिक Tabs सिस्टीम वापरत आहोत, ज्यामुळे स्टेट कधीच बदलणार नाही
    ...
    with tab2:
        ...
        if st.button("🚀 स्मार्ट वेळापत्रक तयार करा", key="btn2"):
            with st.spinner("AI तुमच्यासाठी वेळापत्रक डिझाईन करत आहे..."):
                sys_prompt = "तुम्ही शैक्षणिक समुपदेशक आहात. विद्यार्थ्याने दिलेल्या परीक्षेसाठी आणि वेळेसाठी १ आजारी/सामान्य आठवड्याचे कस्टमाइज्ड अभ्यासाचे वेळापत्रक मराठीत अत्यंत आकर्षक बुलेट पॉईंट्समध्ये तयार करा."
    ...
    # --- TAB 3: Scholarship Recommendation ---
    with tab3:
    ...
    # --- TAB 4: Competitive Exam Support ---
    with tab4:
        st.markdown("### 🎯 Competitive Exam Support Module")
        exam_track = st.radio("तुमचे ध्येय निवडा:", ["NEET Medical", "JEE Engineering", "NDA Defence Forces", "MPSC/UPSC Civil Services"], key="r4")
    ...
    # --- TAB 6: Multi-language Accessibility ---
    with tab6:
